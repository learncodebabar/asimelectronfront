      ...
      <div className="scm-window">
        ...
        <div className="scm-tb">
          ...
          <span className="scm-tb-title">
            Raw Sale Invoice— {salePayload.invoiceNo} &nbsp;|&nbsp;{" "}
...
export default function RawSalePage() {
  ...
  const handleCustomerSelect = (c) => {
    ...
    if (type === "raw-sale" || type === "supplier") {
  ...
  const openSaleConfirm = () => {
    ...
    if (
      customerId &&
      (customerType === "raw-sale" || customerType === "supplier")
    ) {
      ...
      <div className={`sl-page${creditWarning ? " sl-credit-mode" : ""}`}>
        ...
        <div className="xp-titlebar">
          ...
          <span className="xp-tb-title">
            Raw Sale Invoice — Asim Electric &amp; Electronic Store
          </span>
                    ...
                    if (e.key === "Enter") {
                      ...
                      try {
                        const { data } = await api.get(
                          EP.RAW_SALES.GET_ALL + `?invoiceNo=${val}`,
                        );
        ...
        <div className="sl-cmd-bar">
          ...
          <button
            ...
            onClick={async () => {
              ...
              try {
                await api.delete(EP.RAW_SALES.DELETE(editId));
