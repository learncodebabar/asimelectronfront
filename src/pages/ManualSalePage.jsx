  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", background: "#ffffff" }}>
      ...
      <div style={{ padding: "12px 16px", background: "#ffffff", flex: 1, overflow: "auto" }}>
        ...
        {/* Main Content Area - Two column layout: 85% inputs / 15% customer image */}
        <div style={{
          background: "#ffffff",
          borderRadius: "6px",
          padding: "12px 16px",
          ...
          <div style={{ flex: "85", minWidth: 0 }}>
            ...
            <div style={{ 
              ...
              <div>
                ...
                <input ref={invRef} type="text" 
                style={{ fontSize: "12px", padding: "6px 8px", border: "1px solid #000000", borderRadius: "3px", width: "100%" }} 
                value={row.invoiceNo} onChange={(e) => updateRow("invoiceNo", e.target.value)}
                 onKeyDown={(e) => handleRowKeyDown(e, 'inv')} placeholder="" />
              </div>
              
              {/* AMOUNT */}
              <div>
                <label style={{ fontSize: "10px", fontWeight: "bold", display: "block", marginBottom: "2px" }}>AMOUNT (PKR)</label>
                <input ref={amountRef} type="number" style={{ fontSize: "13px", fontWeight: "bold", padding: "6px 8px", textAlign: "right", border: "1px solid #000000", borderRadius: "3px", width: "100%" }} value={row.amount} onChange={(e) => updateRow("amount", e.target.value)} onKeyDown={(e) => handleRowKeyDown(e, 'amount')} placeholder="0.00" />
              </div>
              
              {/* CONFIRM AMOUNT */}
              <div>
                <label style={{ fontSize: "10px", fontWeight: "bold", display: "block", marginBottom: "2px", color: "#dc2626" }}>CONFIRM AMOUNT</label>
                <input ref={confirmAmountRef} type="number" style={{ fontSize: "13px", fontWeight: "bold", padding: "6px 8px", textAlign: "right", border: "2px solid #dc2626", borderRadius: "3px", width: "100%", background: "#fef2f2" }} value={row.confirmAmount} onChange={(e) => updateRow("confirmAmount", e.target.value)} onKeyDown={(e) => handleRowKeyDown(e, 'confirmAmount')} placeholder="Re-enter amount" />
              </div>
            </div>
          </div>
          
          {/* Right side: Customer Image (15%) */}
