// pages/Reports/SaleReturnWithoutValuesPage.jsx
...
export default function SaleReturnWithoutValuesPage() {
  ...
  const buildPrintHtml = () => {
    const rows = filteredReturns.map((r, i) => `
      <tr>
        ...
        <td style="padding:10px;border:2px solid #000;text-align:center;font-size:13px;font-weight:bold;color:#dc2626">*** *** ***</td>
      </tr>
    `).join("");
    ...
    <head>
      <meta charset="utf-8">
      <title>Sales Return Report (Without Values)</title>
      <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .note{background:#fef3c7;padding:8px;margin:10px 0;border:1px solid #dc2626;text-align:center;color:#78350f;font-size:11px;font-weight:bold}
    ...
    <body>
      ...
      <div class="title">SALES RETURN REPORT (WITHOUT VALUES)</div>
      ...
      <div class="totals">
        ...
        <div class="totals-row bold"><span>Total Return Amount:</span><span>[CONFIDENTIAL]</span></div>
      </div>
  ...
  const buildSingleReturnHtml = (returnItem) => {
    const rows = (returnItem.items || []).map((item, i) => `
      <tr>
        ...
        <td style="padding:8px;border:1px solid #000;text-align:center;font-weight:bold;color:#dc2626">***</td>
        <td style="padding:8px;border:1px solid #000;text-align:center;font-weight:bold;color:#dc2626">***</td>
      </tr>
    `).join("");
    ...
    <head>
      ...
      <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .note{background:#fef3c7;padding:6px;margin:10px 0;border:1px solid #dc2626;text-align:center;font-size:11px;font-weight:bold;color:#78350f}
        table{width:100%;border-collapse:collapse;margin:15px 0}
    ...
    <body>
      ...
      <div class="total">TOTAL RETURN AMOUNT: [CONFIDENTIAL]</div>
  ...
  return (
    <div className="sl-page">
      ...
      <div style={{ padding: "16px" }}>
        {/* Confidential Notice */}
        <div style={{ background: "#fef3c7", padding: "10px", marginBottom: "16px", borderRadius: "6px", border: "2px solid #dc2626", textAlign: "center" }}>
          <span style={{ fontWeight: "bold", color: "#78350f", fontSize: "13px" }}>⚠ CONFIDENTIAL REPORT - PRICES ARE HIDDEN ⚠</span>
        </div>
          ...
          <div style={{ display: "flex", gap: "12px", alignItems: "flex-end", flexWrap: "wrap" }}>
            <div>
              ...
              <input 
                ...
                style={{ border: "1px solid #dc2626", borderRadius: "4px", padding: "8px", fontSize: "13px" }} 
              />
            </div>
            <div>
            ...
            <div style={{ flex: 1 }}>
              ...
              <input 
                ...
                style={{ border: "1px solid #dc2626", borderRadius: "4px", padding: "8px", fontSize: "13px", width: "100%" }} 
              />
            </div>
            <div style={{ flex: 1 }}>
        ...
        {filteredReturns.length > 0 && (
          <div style={{ display: "flex", gap: "12px", marginBottom: "20px", flexWrap: "wrap" }}>
            ...
            <div style={{ background: "#6b7280", color: "white", padding: "12px 20px", borderRadius: "6px", flex: 1, textAlign: "center", border: "1px solid #000" }}>
              <div style={{ fontSize: "11px", opacity: 0.9 }}>RETURN AMOUNT</div>
              <div style={{ fontSize: "20px", fontWeight: "bold" }}>CONFIDENTIAL</div>
            </div>
          </div>
        )}
        ...
        <div className="xp-table-panel" style={{ border: "2px solid #dc2626", borderRadius: "8px" }}>
          <div className="xp-table-scroll" style={{ maxHeight: "calc(100vh - 420px)", overflow: "auto" }}>
            <table className="xp-table" style={{ width: "100%", borderCollapse: "collapse", fontSize: "12px" }}>
              <thead>
                <tr style={{ background: "#dc2626", color: "white", position: "sticky", top: 0 }}>
                  ...
                  <th style={{ padding: "10px", border: "1px solid #000", textAlign: "center", width: "120px" }}>AMOUNT</th>
              ...
              <tbody>
                ...
                {filteredReturns.map((r, i) => (
                  <tr key={r._id} style={{ borderBottom: "1px solid #e2e8f0" }}>
                    ...
                    <td style={{ padding: "8px", border: "1px solid #dc2626", textAlign: "center", fontWeight: "bold", color: "#dc2626" }}>*** *** ***</td>
                    <td style={{ padding: "8px", border: "1px solid #dc2626", textAlign: "center" }}>
                      <button 
                        className="xp-btn xp-btn-sm" 
                        style={{ fontSize: "10px", padding: "4px 8px", background: "#dc2626", color: "white", border: "1px solid #000", cursor: "pointer" }} 
              ...
              {filteredReturns.length > 0 && (
                <tfoot style={{ background: "#f8fafc", borderTop: "2px solid #dc2626" }}>
                  <tr>
                    ...
                    <td style={{ padding: "10px", textAlign: "center", fontWeight: "bold", color: "#dc2626", fontSize: "13px" }}>[CONFIDENTIAL]</td>
      ...
      <div className="xp-statusbar" style={{ background: "#f8fafc", borderTop: "2px solid #dc2626", padding: "6px 16px" }}>
        <div className="xp-status-pane" style={{ fontSize: "11px", fontWeight: "500" }}>Sales Return Report (Without Values)</div>
        <div className="xp-status-pane" style={{ fontSize: "11px", fontWeight: "500" }}>Records: {filteredReturns.length}</div>
        <div className="xp-status-pane" style={{ fontSize: "11px", fontWeight: "500" }}>Amount: [CONFIDENTIAL]</div>
      </div>
    </div>
  );
}